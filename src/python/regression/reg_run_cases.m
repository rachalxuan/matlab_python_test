...
function record = localEmptyRecord()
    ...
    diagnosticFields = localDiagnosticNumericResultFields();
    for k = 1:numel(diagnosticFields)
        record.(diagnosticFields{k}) = NaN;
    end
...
function T = localResultsTable(records)
    ...
    diagnosticFields = localDiagnosticNumericResultFields();
    for j = 1:numel(diagnosticFields)
        T.(diagnosticFields{j}) = nan(n,1);
    end
...
function names = localDiagnosticNumericResultFields()
    names = { ...
        'CRCCheckedFrames','CRCErrorFrames','CRCErrorRate', ...
        ...
        'DemodNoiseVariance','NoiseBandwidthHz','NoisePower_dBm', ...
        'NoiseEquivalentSNR_dB','NoiseReferenceLevel_dBm', ...
        'ConverterChainEnabled','BasebandIFLevel_dBm', ...
        'UpconverterNetGain_dB','UpconverterAttenuation_dB', ...
        'UpconverterOutputLevel_dBm','UpconverterCompressionRisk', ...
        'HAppliedGain_dB','DownconverterInputLevel_dBm', ...
        'DownconverterNetGain_dB','DownconverterAttenuation_dB', ...
        'DownconverterAutoAttenuation','DownconverterOutputLevel_dBm', ...
        'DownconverterInputWithinTypicalRange', ...
        'DownconverterCompressionRisk','ADCEquivalentEnabled', ...
        'ADCRMSBackoff_dB','ADCClipFraction', ...
        ...
        'UQPSKCarrierPLLLocked','UQPSKCarrierPLLAcquireBW', ...
        'UQPSKCarrierPLLTrackBW','UQPSKCarrierPLLFinalFrequency_Hz', ...
        'UQPSKCarrierPLLLockTransitions','UQPSKCarrierPLLReacquisitions', ...
        ...
        'FastEnvelopeFinalGain_dB','FastEnvelopeGainMin_dB', ...
        'FastEnvelopeGainMax_dB', ...
        ...
        'ASMTrainingEqualizerASMCount', ...
        'ASMTrainingEqualizerUpdates', ...
        'ASMTrainingEqualizerMedianScoreBefore', ...
        'ASMTrainingEqualizerMedianScoreAfter', ...
        'GMSKSecondOrderPLLApplied', ...
        'GMSKSecondOrderPLLLocked', ...
