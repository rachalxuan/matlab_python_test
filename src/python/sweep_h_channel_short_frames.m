...
function opts = localDefaultOptions(thisDir)
    ...
    opts.gmskBT = 0.5;
    % Production GMSK receiver.  Use 'legacy-diff' only for an explicit
    % detector A/B diagnostic; never select it implicitly in a sweep.
...
function names = localVariableNames()
    names = {'CaseIndex', ...
        ...
        'EqualizerMode', 'FastEnvelopeTauSymbols', ...
